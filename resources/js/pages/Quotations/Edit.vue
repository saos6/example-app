...
import { Quotation, Customer, Person, Product } from '@/types';
...
const form = useForm({
    ...
    person_id: props.quotation.person_id,
    quotation_date: props.quotation.quotation_date,
    items: props.quotation.quotation_items.map(item => ({
...
<template>
    ...
    <AppLayout>
        <template #header>
            <h2 class="font-semibold text-xl text-gray-800 leading-tight">見積編集</h2>
        </template>
